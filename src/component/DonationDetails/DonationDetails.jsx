...
const DonationDetails = ({ storeData }) => {
    ...
    return (
        <div>
            <div style={{ backgroundColor: `${bg_color}` }} className="card md:card-side shadow-xl ">
                <figure><img src={image} className='w-96 h-60' alt="Movie" /></figure>
                <div className="card-body">
                    <h2 style={{ color: `${text_color}`, backgroundColor: `${category_color}` }} className='text-center py-2 w-1/2 lg:w-1/3 rounded-lg'>{category}</h2>
